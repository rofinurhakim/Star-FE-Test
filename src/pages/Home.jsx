...
const HomePage = () => {
    ...
    let slides = [
        <img  onClick={() => history.push('/Detail')}  src="https://picsum.photos/800/300/?random" alt="1" />,
        <img  onClick={() => history.push('/Detail')} src="https://picsum.photos/800/301/?random" alt="2" />  ,
        <img  onClick={() => history.push('/Detail')} src="https://picsum.photos/800/302/?random" alt="3" />  ,
        <img  onClick={() => history.push('/Detail')} src="https://picsum.photos/800/303/?random" alt="4" />  ,
        <img  onClick={() => history.push('/Detail')} src="https://picsum.photos/800/304/?random" alt="5" />   ];
